...
//	void New();
	...
	void Choose_FreeShape();					// Choose FreeShape region
	void copy();								// copy region from source image
...
private:
	...
	QMdiSubWindow *FindChild(const QString &filename);			// find corresponding childwindow in the QMdiArea 
