...
void MainWindow::CreateActions()
{
	...
	action_Setpointpair_ = new QAction(tr("ControlPoints"), this);
	action_Setpointpair_->setChecked(true);
	connect(action_Setpointpair_, &QAction::triggered, imagewidget_, &ImageWidget::IfAddControlPoint);
...
void MainWindow::CreateMenus()
{
	...
	menu_edit_->addAction(action_Setpointpair_);
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->addAction(action_Setpointpair_);
